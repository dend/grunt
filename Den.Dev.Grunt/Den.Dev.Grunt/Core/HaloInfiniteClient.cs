...
namespace Den.Dev.Grunt.Core
{
    ...
    public class HaloInfiniteClient : ClientBase
    {
        ...
        /// <remarks>
        /// This function is likely used as a POST as well (hence the name - right now we're only using GET). Once we discover how this API works, we can extend the functionality further. <see href="https://github.com/OpenSpartan/Den.Dev.Grunt/issues/14">GitHub issue</see>.
        /// </remarks>
        /// <param name="player">The unique player XUID, in the format "xuid(XUID_VALUE)".</param>
        ...
        /// </summary>
        /// <remarks>
        /// TODO: Need to figure out what the API response here is. Haven't seen this actually activated in-game. For the time being, the API call will return a raw response. For details, see <see href="https://github.com/OpenSpartan/Den.Dev.Grunt/issues/18">GitHub issue</see>.
        /// </remarks>
        ...
        public async Task<HaloApiResultContainer<PlayerServiceRecord, RawResponseContainer>?> StatsGetPlayerServiceRecord(string playerId, LifecycleMode mode, string seasonId = "")
        {
            ...
            return await this.ExecuteAPIRequest<PlayerServiceRecord>(
                $"https://{HaloCoreEndpoints.StatsOrigin}.{HaloCoreEndpoints.ServiceDomain}/hi/players/{playerId}/{mode}/servicerecord{seasonMarker}",
                HttpMethod.Get,
                true,
                false,
                includeRawResponse: this.IncludeRawResponses);
