...
namespace Den.Dev.Grunt.Librarian
{
    class Program
    {
        static void Main()
        {
            Console.WriteLine("Den.Dev.Grunt Librarian - Halo Infinite API Indexer");
            Console.WriteLine("Developed by Den Delimarsky in 2022. Part of https://Den.Dev.Gruntapi.com");
