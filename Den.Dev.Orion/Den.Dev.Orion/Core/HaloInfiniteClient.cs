...
namespace Den.Dev.Orion.Core
{
    ...
    public class HaloInfiniteClient : ClientBase
    {
        ...
        /// <remarks>
        /// This function is likely used as a POST as well (hence the name - right now we're only using GET). Once we discover how this API works, we can extend the functionality further. <see href="https://github.com/OpenSpartan/Den.Dev.Orion/issues/14">GitHub issue</see>.
        /// </remarks>
        /// <param name="player">The unique player XUID, in the format "xuid(XUID_VALUE)".</param>
