...
namespace Den.Dev.Grunt.Core.Modules.HaloInfinite
{
    ...
    /// </summary>
    public sealed class LobbyModule : ModuleBase
    {
        /// <summary>
        ...
        public Task<HaloApiResultContainer<List<Server>, RawResponseContainer>> GetQosServersAsync(CancellationToken cancellationToken = default)
        {
            return this.GetAsync<List<Server>>("/titles/hi/qosservers", cancellationToken: cancellationToken);
        }
        ...
        public Task<HaloApiResultContainer<LobbyPresenceContainer, RawResponseContainer>> GetPresenceAsync(LobbyPresenceRequestContainer presenceRequest, CancellationToken cancellationToken = default)
        {
            ArgumentNullException.ThrowIfNull(presenceRequest);

            return this.PostJsonAsync<LobbyPresenceContainer, LobbyPresenceRequestContainer>("/hi/presence", presenceRequest, cancellationToken: cancellationToken);
        }
        ...
        public Task<HaloApiResultContainer<LobbyJoinHandle, RawResponseContainer>> GetThirdPartyJoinHandleAsync(string lobbyId, string player, string handleAudience, string handlePlatform, CancellationToken cancellationToken = default)
        {
            ArgumentException.ThrowIfNullOrEmpty(lobbyId);
            ArgumentException.ThrowIfNullOrEmpty(player);
            ArgumentException.ThrowIfNullOrEmpty(handleAudience);
            ArgumentException.ThrowIfNullOrEmpty(handlePlatform);

            return this.GetAsyncFullUrl<LobbyJoinHandle>(
        ...
        public Task<HaloApiResultContainer<JoinLobbyResponse, RawResponseContainer>> JoinLobbyAsync(string lobbyId, string player, string auth, byte[] lobbyBootstrapPayload, CancellationToken cancellationToken = default)
        {
            ArgumentException.ThrowIfNullOrEmpty(lobbyId);
            ArgumentException.ThrowIfNullOrEmpty(player);
            ArgumentException.ThrowIfNullOrEmpty(auth);
            ArgumentNullException.ThrowIfNull(lobbyBootstrapPayload);

            return this.Client.ExecuteAPIRequestAsync<JoinLobbyResponse>(
