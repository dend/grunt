...
Welcome to **Den.Dev.Grunt API** - the unofficial way to use official undocumented Halo APIs. Here be **a lot of dragons**. I created this project for my own stat tracking and it will never be public.
